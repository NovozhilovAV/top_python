...
# картой.
# 6. Необходимо иметь возможность просмотреть количество проданных хот-догов,
# выручку, прибыль.
# 7. Необходимо иметь возможность просмотреть информацию о наличии компонентов
# для создания хот-дога.
