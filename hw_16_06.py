# Модуль 20. Фреймворки. Часть 2
# Задание 1
# Используя механизм маршрутизации создайте веб-приложение,
# отображающее разные разделы с информацией о вашем городе.
...
# Если было указано 127.0.0.1:8000/news, должен от-
# крыться раздел Новости города.
# Если было указано 127.0.0.1:8000/management, должен
# открыться раздел Руководство города и т.д.

# Задание 2
# Добавьте к проекту из первого задания возможность
# обработки неправильных адресов.
# Например, при указании 127.0.0.1:8000/news/satis-
# faction или 127.0.0.1:8000/news/angie, или 127.0.0.1:8000/
